...
\subsection*{Venomous Snake Bite}
...
Once when wounded the victim sees that there is no flesh inside them.

In its place one can find only crumbling clay, withered fabric and sawdust. 
However, despite all the differences, you feel the same. Maybe a bit duller to touch, feel less pain. At last you notice that your wounds are permanent.
...
\begin{itemize}[nosep]
    \item You don't lose Vigor. Since when you discover this change in yourself, secretly record damage you receive that would have been subtracted from your \texttt{Vigor}.
    \item For each 3 points of this damage accumulated this way treat your maximum \texttt{Vigor} as if it is reduced by \texttt{1}. When it reaches \texttt{0} your body loses structural integrity and dissolves to dust.
    \item You accumulate \texttt{Injuries} based on damage received and wither away when out of \texttt{Injury slots}.
...
Fever was gone in a day. Swiftness of your recovery and strength you gathered amazing anybody who ever saw an infected wound like yours. 
...
You move with visible delay and your reaction is impaired. You find another ulcer on your skin, you feel neither pain, nor distress. 

\begin{itemize}[nosep]
    \item Your maximum \texttt{Guard} becomes \texttt{0} if it was even and \texttt{1} if it was odd.
    \item For each \texttt{2} points of \texttt{Guard} lost this way increase your maximum \texttt{Vigor} by \texttt{1}, up to \texttt{19}.
