...
If you find a puppet master that will agree to such outstanding demand, they could find a way to patch your body to its former shape.
They will not be able to heal you from the illness.

\begin{itemize}[nosep]
    \item Since when you discover this change in yourself, start secretly recording damage you receive that would have been subtracted from your \texttt{Vigor}.
    ...
    \item You still accumulate \texttt{Injuries} and can wither away when you are out of \texttt{Injury slots}.
