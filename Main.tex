...
\begin{multicols*}{2}
    ...
    \begin{itemize}[nosep]
        ...
        \item You don't do physical damage, but you can give \texttt{Trauma} if you would have dealt enough damage to cause an \texttt{Injury}. Additionally, ignore armour for \texttt{Injury} calculations.
