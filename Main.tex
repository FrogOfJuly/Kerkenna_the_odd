...
\begin{multicols*}{2}
    ...
    \begin{itemize}[nosep]
        ...
        \item It has \texttt{1} \texttt{Vigor}, \texttt{0} Armour, but otherwise keeps your parameters. 
              Physical damage applies to you the same, but is targets \texttt{Spirit} instead of \texttt{Vigor}. 
        ...
        \item You don't do physical damage, but you can give \texttt{Trauma} if you would have dealt enough damage to cause an \texttt{Injury}.       
